...
const RegisterNew = () => {
  ...
  return (
        <>
          <div className="button-container" style={{margin:"2% 0% -2.5% 0%",flexDirection:"row",justifyContent:"space-between"}}>
              <div style={{display:"flex",justifyContent:"start"}}>
                ...
                <button type="button" className="join details"  style={{ cursor: "pointer" ,fontSize:"30px",background:"none" }} onClick={() => navigate('/register/teams')}>
                  Available Teams
                </button>
              ...
              <div style={{display:"flex",justifyContent:"end"}}>
                ...
                <button type="button" className="join details" style={{ cursor: "pointer" ,fontSize:"30px",background:"none" }} onClick={() => {navigate('/register/members')}}>
                  Team Details
                </button>
    ...
    <div className="two" id="two" style={{marginTop:"5%"}}>
          ...
          <h1 id="registration" className="reg" style={{margin:"0% 0% 3% 0%",fontSize:"65px",fontWeight:"300"}}>REGISTRATION</h1>
