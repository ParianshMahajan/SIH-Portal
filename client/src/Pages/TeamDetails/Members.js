...
const Members = () => {
  ...
  return (
    <div className="wrapper">
      ...
      <h1 id="registration" className="reg" style={{margin:"3% 0% 0% 0%",letterSpacing:"0px",fontWeight:"1500"}}>SIH</h1>
      
       
       
        {joincode &&
        <>
        <h1 id="registration" className="reg" style={{margin:"0% 0% 1% 0%",fontSize:"65px",fontWeight:"300"}}>REGISTRATION</h1>
        ...
        <h1 id="registration" className="reg" style={{margin:"0% 0% 1% 0%",fontSize:"65px",fontWeight:"300"}}>{details.TeamName}</h1>
        <div className="regform" style={{display:"flex",float:"left",justifyContent:"start",margin:"-8% 5% 0% 4%"}} >
          ...
          <div className="leaderboardcont" style={{height:"530px",marginTop:"0%"}}>{
            details.Members.map((e)=>{
              return(

                <div className="team">
                        <h5 className="teamname">{e.Name}</h5>
                        <h5 className="teamname" style={{width:"5%"}}>{(e.Gender=="Male"?'M':'F')}</h5>
                        <h5 className="teamname" style={{width:"25%",fontSize:"18px"}}>{`+91 ${e.PhoneNumber}`}</h5>
                        <h5 className="pts" style={{width:"35%"}}>{`Tech Stack : ${e.TechStack}`}</h5>
                    </div>                
                )
                }) 
              }
        ...
        {!details.submitted &&
        <div style={{display:"flex",justifyContent:"center",width:"100%",marginTop:"-1%"}}>
        ...
        {mssg &&
        <>
        <h1 id="registration" className="reg" style={{margin:"0% 0% 1% 0%",fontSize:"65px",fontWeight:"300"}}>TeamName</h1>
